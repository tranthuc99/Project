...
int main()
{
    ...
    char x1[] = " Nhap so an cua he phuong trinh                     ||";
            ...
            if (kbhit()) {
                ...
                if (key == 13) {
                    ...
                    case 0:
                        do {
                            printf ("\n\t----------------------------------------\n");
                            printf ("\t*Nhap so an cua he phuong trinh: ");
                            scanf ("%d", &n_degree);
                            if (n_degree < 1 || n_degree > MAX)
                                printf ("\n\tSo an khong hop le. Xin kiem tra lai !");
                    ...
                    case 1:
                        if (flag_import) {
                            ...
                            printf ("\nNhap so an cua he phuong trinh truoc !!!");
                            getch();
                            break;
                        }
                        printf ("\t----------------------------------------------------------\n");
                    ...
                    case 3:
                        if (flag_import) {
                            ...
                            printf ("\nNhap so an cua he phuong trinh & nhap ma tran A,b truoc !!!");
                            getch();
                            break;
                        }
                        printf ("\t----------------------------------------------------------\n");
                    ...
                    case 8:
                        ...
                        fileOut = fopen (FILE_OUTPUT, "a");
                        fprintf (fileOut, "\n 6. TÍNH NGHIỆM GẦN ĐÚNG THỎA MÃN ĐỀ: e = %lf\n", e);
                        fclose (fileOut);
...
void seidel_iterative_method (double a[][MAX], double result[][MAX], int n, int k)
{
    ...
    for (h = 1; h <= k; h++) {
        ...
        for (p = 1; p <= n; p++)
            result[1][h] += a[1][p] * result[p][h-1];
        for (q = 2; q <= n; q++) {
            result[q][h] = result[q][0];
            for (m = 1; m <= q-1; m++)
                result[q][h] += a[q][m] * result[m][h];
            for (t = q; t <= n; t++)
                result[q][h] += a[q][t] * result[t][h-1];
        }
    }
}
